...
MACRO_CONFIG_INT(SvScoreSpikeRED, sv_score_spike_red, 6, 0, 100, CFGFLAG_SERVER, "Points for grabbing into this spike")
MACRO_CONFIG_INT(SvScoreSpikeORANGE, sv_score_spike_orange, 5, 0, 100, CFGFLAG_SERVER, "Points for grabbing into this spike")
...
MACRO_CONFIG_INT(SvScoreSpikeLBLUE, sv_score_spike_lblue, 3, 0, 100, CFGFLAG_SERVER, "Points for grabbing into this spike")
MACRO_CONFIG_INT(SvScoreSpikeBLUE, sv_score_spike_blue, 4, 0, 100, CFGFLAG_SERVER, "Points for grabbing into this spikes")
MACRO_CONFIG_INT(SvScoreSpikePURPLE, sv_score_spike_purple, 10, 0, 100, CFGFLAG_SERVER, "Points for grabbing into this spike")
MACRO_CONFIG_INT(SvScoreSpikePINK, sv_score_spike_pink, 7, 0, 100, CFGFLAG_SERVER, "Points for grabbing into this spike")
MACRO_CONFIG_INT(SvScoreSpikeWHITE, sv_score_spike_white, 2, 0, 100, CFGFLAG_SERVER, "Points for grabbing into this spike")
MACRO_CONFIG_INT(SvScoreSpikeBLACK, sv_score_spike_black, 15, 0, 100, CFGFLAG_SERVER, "Points for grabbing into this spike")

MACRO_CONFIG_INT(SvGiveWeapon, sv_give_weapon, 3, 3, 4, CFGFLAG_SERVER, "whether to give laser to players")
